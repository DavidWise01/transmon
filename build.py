...
footer{margin-top:46px;padding-top:22px;border-top:1px solid var(--line);text-align:center;font-family:var(--mono);font-size:10.5px;color:var(--dim);letter-spacing:.04em;line-height:1.95}footer a{color:var(--violet2);text-decoration:none}
  ...
  <header>
    ...
    <a href="donor.html" style="display:block;margin-top:18px;padding:15px 18px;border:1px solid var(--violet,#8b5cf6);background:rgba(139,92,246,.07);text-decoration:none;color:var(--pa);font-family:var(--mono);font-size:12.5px;line-height:1.65">
      <b style="color:var(--violet2,#a78bfa)">▸ THE DONOR · As · P · Sb · Bi</b> — the group-V atom that dopes your CPU's transistor channels (where classical inference physically runs) AND, implanted single-atom, holds a qubit. The channel-vs-gap question answered, the nuclear-spin ladder (½→7/2 qudit), and a live doping slider for the <b>Mott ceiling</b> — the density where a qubit becomes a wire. <span style="color:var(--violet2,#a78bfa)">enter →</span></a>
  </header>
...
<a href="https://davidwise01.github.io/gravity-bracket/" style="flex:1 1 210px;text-decoration:none;background:#0b0f18;border:1px solid #172230;border-left:3px solid #6fb8e0;border-radius:5px;padding:13px 15px"><div style="font-family:monospace;font-size:16px;font-weight:700;color:#6fb8e0">{ G [ s | a | q ] G }</div><div style="font-family:monospace;font-size:9.5px;color:#8fa3b8;margin:5px 0 6px;text-transform:uppercase;letter-spacing:.06em">The Gravity Bracket · the frame</div><div style="font-size:13px;color:#9aaabd;line-height:1.5">gravity bookends the silicon · atomic · quantum stack at both ends of scale</div></a>
<a href="https://davidwise01.github.io/transmon/" style="flex:1 1 210px;text-decoration:none;background:#0b0f18;border:1px solid #57c79a;border-left:3px solid #57c79a;border-radius:5px;padding:13px 15px"><div style="font-size:17px;font-weight:700;color:#57c79a">The Josephson Junction</div><div style="font-family:monospace;font-size:9.5px;color:#8fa3b8;margin:5px 0 6px;text-transform:uppercase;letter-spacing:.06em">the junction that CLOSES · here</div><div style="font-size:13px;color:#9aaabd;line-height:1.5">a junction + a capacitor = an artificial atom: s (built) → a (its energy ladder) → q (a qubit). coherence tunnels the gap on command.</div><div style="font-family:monospace;font-size:9px;color:#57c79a;margin-top:7px">▸ you are here</div></a>
<a href="https://davidwise01.github.io/quantum-gravity/" style="flex:1 1 210px;text-decoration:none;background:#0b0f18;border:1px solid #172230;border-left:3px solid #ff5a4d;border-radius:5px;padding:13px 15px"><div style="font-size:17px;font-weight:700;color:#ff5a4d">Quantum Gravity</div><div style="font-family:monospace;font-size:9.5px;color:#8fa3b8;margin:5px 0 6px;text-transform:uppercase;letter-spacing:.06em">the junction that WON'T</div><div style="font-size:13px;color:#9aaabd;line-height:1.5">GR and QM face each other across the Planck gap and nothing coherent crosses — the bracket's open clasp.</div></a>
</div>
<div style="margin-top:13px;padding:13px 16px;border:1px solid #2a3140;border-radius:5px;background:rgba(87,199,154,.05);font-size:14.5px;color:#cdd8e6;font-style:italic;line-height:1.6">The Josephson junction is the proof the s|a|q side is masterable — a built seam where the quantum crosses on command; quantum gravity is the one seam where it can't. Same diagram, opposite verdict.</div></section>
